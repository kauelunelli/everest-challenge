...
createServer({
  ...
  seeds(server) {
    ...
    server.create("user", { id: 3, fullname: "Heitor Villa-Lobos", cpf: "93525294056", phone: "80986882515", email: "hvlobos@mail.com", confirmEmail: "hvlobos@mail.com", birthDate: "1887-03-05", contact: 'whatsapp' })
    ...
    server.create("user", { id: 5, fullname: "Augustin Barrios", cpf: "14938840006", phone: "86986882519", email: "abarrios@mail.com", confirmEmail: "abarrios@mail.com", birthDate: "1885-05-05", contact: 'whatsapp' })
    ...
    server.create("user", { id: 7, fullname: "Ciquinha Gonzaga", cpf: "96068560031", phone: "80986882515", email: "xgonzaga@mail.com", confirmEmail: "xgonzaga@mail.com", birthDate: "1847-10-17", contact: 'whatsapp' })
    server.create("user", { id: 8, fullname: "Augustin Barrios", cpf: "03903659045", phone: "86986882519", email: "abarrios@mail.com", confirmEmail: "abarrios@mail.com", birthDate: "1885-05-05", contact: 'whatsapp' })
